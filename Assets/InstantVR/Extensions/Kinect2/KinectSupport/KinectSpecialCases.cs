...
namespace Windows.Kinect
{
	...
	/*
    public sealed partial class d_AudioBeamSubFrame
    {
	...
	*/
	/*
    public sealed partial class d_AudioBeamFrame
    {
        private Windows.Kinect.d_AudioBeamSubFrame[] _subFrames = null;
        ...
        private void Dispose(bool disposing)
        {
            ...
            Helper.NativeObjectCache.RemoveObject<d_AudioBeamFrame>(_pNative);
        ...
        public RootSystem.Collections.Generic.IList<Windows.Kinect.d_AudioBeamSubFrame> SubFrames
        {
            get
            {
                if (_pNative == RootSystem.IntPtr.Zero)
                ...
                if (_subFrames == null)
                {
                    ...
                    _subFrames = new Windows.Kinect.d_AudioBeamSubFrame[collectionSize];
                    ...
                    for (int i = 0; i < collectionSize; i++)
                    {
                        ...
                        var obj = Helper.NativeObjectCache.GetObject<Windows.Kinect.d_AudioBeamSubFrame>(outCollection[i]);
                        if (obj == null)
                        {
                            obj = new Windows.Kinect.d_AudioBeamSubFrame(outCollection[i]);
                            Helper.NativeObjectCache.AddObject<Windows.Kinect.d_AudioBeamSubFrame>(outCollection[i], obj);
                        }
