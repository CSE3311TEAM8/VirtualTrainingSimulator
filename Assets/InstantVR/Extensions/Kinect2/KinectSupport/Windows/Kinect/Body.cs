...
namespace Windows.Kinect
{
...

    {
		...
		private static extern int Windows_Kinect_Body_get_Joints(RootSystem.IntPtr pNative, [RootSystem.Runtime.InteropServices.Out] int[] outKeys, [RootSystem.Runtime.InteropServices.Out] Windows.Kinect.Joint[] outValues, int outCollectionSize);[RootSystem.Runtime.InteropServices.DllImport("KinectUnityAddin", CallingConvention=RootSystem.Runtime.InteropServices.CallingConvention.Cdecl, SetLastError=true)]
        private static extern int Windows_Kinect_Body_get_Joints_Length(RootSystem.IntPtr pNative);
		public  RootSystem.Collections.Generic.Dictionary<int, Windows.Kinect.Joint> Joints
        {
            get
            {
                if (_pNative == RootSystem.IntPtr.Zero)
				...
				var outKeys = new int[outCollectionSize]; //new Windows.Kinect.JointType[outCollectionSize];
                var outValues = new Windows.Kinect.Joint[outCollectionSize];
                var managedDictionary = new RootSystem.Collections.Generic.Dictionary<int, Windows.Kinect.Joint>();
